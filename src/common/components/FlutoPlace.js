...
export default function FlutoPlace({ ...props }) {
  const group = useRef();
  const { nodes, materials } = useGLTF("/flutoPlace/scene.gltf");
  ...
  return (
    <>
      <group
        ...
        rotation={[0.6, -5, -0.5]}
      >
        <group rotation={[-Math.PI / 2, 0, 0]} receiveShadow={true}>
          <Shadow
            color="#00497f"
            opacity={2}
            fog={false}
...
useGLTF.preload("/flutoPlace/scene.gltf");
