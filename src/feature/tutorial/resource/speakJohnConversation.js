...
function speakJohnConversation() {
  ...
  return [
    ...
    },
    {
      type: "존이 당신에게 말하고 있습니다.",
      id: 7,
      content: "실망이야 에리스 예전부터 너는 좋은 동료라고 믿고 있었는데..",
    },
    {
      type: "존이 당신에게 말하고 있습니다.",
      id: 8,
    ...
    },
    {
      ...
      id: 9,
      content:
        "에리스, 난 그런 것을 꿈꾸러 나사를 들어온게 아니야 우린 지금 바라보는 방향이 다른 거같아 이만 연락 끊을게 잘지내",
    },
    {
      type: "존이 당신에게 말하고 있습니다.",
      id: 10,
      content:
        "갑자기 동의한다고 말하니 믿음이 가질 않네 에리스.. 날 설득시키고 싶은건 알겠지만 난 찾아야 할 게 많아 시간이 없어 이만 끊을게",
    },
    {
      type: "존이 당신에게 말하고 있습니다.",
      id: 11,
